...
const InnerWorkForm = ({ handleSubmit, isSubmitting, status, setFieldValue }) => {
  ...
  return (
    <Form>
      ...
      <Field name='production_company_ids'
             className='u-full-width'
             component='select'
             multiple
